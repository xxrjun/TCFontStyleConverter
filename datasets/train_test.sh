...
python train.py --dataroot ./FontHandWriting_Dataset_CycleGAN --name fontA2B --model cycle_gan --input_nc 1 --output_nc 1 --display_id 0 --gpu_ids 0
...
python test.py --dataroot ./FontHandWriting_Dataset_CycleGAN/testA --name fontA2B --model test --input_nc 1 --output_nc 1 --no_dropout
